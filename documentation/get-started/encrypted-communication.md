...
![Encrypted Communication](https://github.com/VirgilSecurity/virgil-sdk-php/blob/docs-review/documentation/img/encrypted_communication_intro.png "Encrypted Communication")
...
Use the [approve & publish users guide](https://github.com/VirgilSecurity/virgil-sdk-php/blob/docs-review/documentation/guides/configuration/server-configuration.md) to publish users Virgil Cards on Virgil Services.
...
![Virgil Intro](https://github.com/VirgilSecurity/virgil-sdk-php/blob/docs-review/documentation/img/Guides_introduction.png "Sign & Encrypt")
...
To sign a message, you will need to load Alice's Virgil Key. See [Loading Key](https://github.com/VirgilSecurity/virgil-sdk-php/blob/docs-review/documentation/guides/virgil-key/loading-key.md) guide for more details.
...
In many cases you will need the Sender's Virgil Cards. See [Finding Cards](https://github.com/VirgilSecurity/virgil-sdk-php/blob/docs-review/documentation/guides/virgil-card/finding-card.md) guide to find them.
