...
use Virgil\SDK\Cryptography\CryptoAPI\AbstractVirgilCryptoApi;
use Virgil\SDK\Cryptography\CryptoAPI\Cipher\VirgilStreamCipher;

abstract class AbstractVirgilCrypto implements CryptoInterface
{
    private $cryptoAPI;

    /**
     * VirgilCrypto constructor.
     * @param AbstractVirgilCryptoApi $cryptoApi
     */
    public function __construct(AbstractVirgilCryptoApi $cryptoApi)
    {
