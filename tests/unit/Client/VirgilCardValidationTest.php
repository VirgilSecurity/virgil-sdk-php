    ...
    public function testPredefinedCardGivenValidationShouldReturnTrue()
    {
        ...
        $validationResult = $validator->validate(
            new Card(
                ...
                'alice2', 'member', Buffer::fromBase64('MCowBQYDK2VwAyEAZzBtEQEWMQ9VeJrqSoO939VR5qimaTs4reqe9ut1VPk='), CardScope::TYPE_GLOBAL, [], null, null, '4.0',
                [
    ...
    public function testBadSelfSignBreakValidation()
    {
        ...
        $validationResult = $validator->validate(
            new Card(
                ...
                'alice2', 'member', Buffer::fromBase64('MCowBQYDK2VwAyEApteLzK8uTkPF6fybWXuvVLTfRg9K1cxgZ6ASX8U2bVs='), CardScope::TYPE_GLOBAL, ['customData' => 'qwerty'], 'iPhone6s', 'Space grey one',
                'v4',
                [
                    'eb95e1b31ff3090598a05bf108c06088af5f70cfd6338924932396e9dfce840a' => Buffer::fromBase64('AKEwDQYJYIZIAWUDBAICBQAEQFpw+jB5eDT1Dj3I2WqCewGqhAdG9f8pncAYeYcWHGWIONZlog1gjBb/y5/km8VbIPjrn4wlF0Ld8L5tRqRZOQM='),
                    '3e29d43373348cfb373b7eae189214dc01d7237765e572db685839b64adca853' => Buffer::fromBase64('MFEwDQYJYIZIAWUDBAICBQAEQMpaO3OmXlsYhzR7pvF0Xuu7Dv84r3SRrmqjMvod9ik+oQ0M0uc+dwHNeNtQpy84qI14cXXaMAJDcfgtKyHPdA0=')
                ]
            )
        );
